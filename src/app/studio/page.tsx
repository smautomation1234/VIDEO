  ...
  return (
    <main className="shell">
      ...
      <section className="hero">
        <div>
          <p className="eyebrow">POWERED BY GEMINI OMNI FLASH</p>
          <h1>One photo. Approved prompts.<br />Selectable video takes.</h1>
        </div>
        <p className="muted hero-note">Gemini fact-checks and fits the script. You approve the visible prompts, Gemini Omni Flash generates each clip with the same attached presenter image, and you choose which takes enter the final scene.</p>
      </section>
