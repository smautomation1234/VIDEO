  ...
  return (
    <main className="auth-shell">
      <section className="auth-card">
        <p className="eyebrow">REELFORGE · GEMINI OMNI FLASH</p>
        <h1>Turn one post into<br />a finished AI Reel.</h1>
        <p className="muted">Fact-checked Gemini prompts, human approval, identity-consistent Gemini Omni Flash clips, selectable regeneration takes, trimming and MP4 export.</p>
